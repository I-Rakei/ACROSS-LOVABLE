...
const services = [
  {
    ...
    desc: {
      en: "Comprehensive corporate travel services designed to support companies, executives and organised business groups.",
  ...
  },
  {
    ...
    desc: {
      en: "Integrated ground transportation and mobility solutions ensuring reliability, safety and efficiency.",
  ...
  },
  {
    ...
    desc: {
      en: "Authentic leisure travel experiences designed with deep local knowledge and full flexibility.",
